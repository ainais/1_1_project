...
public class CustomerVO {
	...
	public String getUserMinPW() {
		return userMinPW;
	}
	public void setUserMinPW(String userMinPW) {
		this.userMinPW = userMinPW;
	}
	...
	public String getSubRemainDate() {
		return subRemainDate;
	}
	public void setSubRemainDate(String subRemainDate) {
		this.subRemainDate = subRemainDate;
	}
